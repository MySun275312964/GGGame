...
public class GateTunnelGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.gg.protocol.gate.GateRpc.Message,
      com.gg.protocol.gate.GateRpc.Message> METHOD_TUNNEL =
    ...
    return io.grpc.ServerServiceDefinition.builder(SERVICE_NAME)
        .addMethod(
          ...
          asyncBidiStreamingCall(
            new MethodHandlers<
              com.gg.protocol.gate.GateRpc.Message,
              com.gg.protocol.gate.GateRpc.Message>(
