...
public class TestGrpc {
    ...
    public static final io.grpc.MethodDescriptor<com.gg.example.test.protocol.Example.TestRequest, com.gg.example.test.protocol.Example.TestResponse> METHOD_POST =
            io.grpc.MethodDescriptor.create(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
                    generateFullMethodName("Test", "post"),
                    io.grpc.protobuf.ProtoUtils
                            .marshaller(com.gg.example.test.protocol.Example.TestRequest.getDefaultInstance()),
                    io.grpc.protobuf.ProtoUtils
                            .marshaller(com.gg.example.test.protocol.Example.TestResponse.getDefaultInstance()));
    ...
    public static class TestStub extends io.grpc.stub.AbstractStub<TestStub> implements Test {
    ...
    public static class TestFutureStub extends io.grpc.stub.AbstractStub<TestFutureStub> implements TestFutureClient {
    ...
    public static io.grpc.ServerServiceDefinition bindService(final Test serviceImpl) {
        return io.grpc.ServerServiceDefinition.builder(SERVICE_NAME)
                .addMethod(METHOD_POST,
                        asyncBidiStreamingCall(
                                new MethodHandlers<com.gg.example.test.protocol.Example.TestRequest, com.gg.example.test.protocol.Example.TestResponse>(
