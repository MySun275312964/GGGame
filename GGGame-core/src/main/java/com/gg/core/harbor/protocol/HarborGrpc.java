...
public class HarborGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.gg.core.harbor.protocol.HarborOuterClass.HarborMessage,
      com.gg.core.harbor.protocol.HarborOuterClass.HarborMessage> METHOD_POST =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "Harbor", "post"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.gg.core.harbor.protocol.HarborOuterClass.HarborMessage.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.gg.core.harbor.protocol.HarborOuterClass.HarborMessage.getDefaultInstance()));
  ...
  public static HarborBlockingStub newBlockingStub(
      io.grpc.Channel channel) {
    return new HarborBlockingStub(channel);
  }

  public static HarborFutureStub newFutureStub(
      io.grpc.Channel channel) {
  ...
  public static class HarborStub extends io.grpc.stub.AbstractStub<HarborStub>
      implements Harbor {
    ...
    @java.lang.Override
    protected HarborStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  public static class HarborBlockingStub extends io.grpc.stub.AbstractStub<HarborBlockingStub>
    ...
    @java.lang.Override
    protected HarborBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  public static class HarborFutureStub extends io.grpc.stub.AbstractStub<HarborFutureStub>
    ...
    @java.lang.Override
    protected HarborFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  public static io.grpc.ServerServiceDefinition bindService(
      final Harbor serviceImpl) {
    return io.grpc.ServerServiceDefinition.builder(SERVICE_NAME)
        .addMethod(
          METHOD_POST,
          asyncBidiStreamingCall(
            new MethodHandlers<
              com.gg.core.harbor.protocol.HarborOuterClass.HarborMessage,
              com.gg.core.harbor.protocol.HarborOuterClass.HarborMessage>(
