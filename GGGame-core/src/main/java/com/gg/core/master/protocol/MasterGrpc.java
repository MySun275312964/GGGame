...
public class MasterGrpc {
    ...
    public static final io.grpc.MethodDescriptor<com.gg.core.master.protocol.MasterOuterClass.MasterRegisterMessage, com.gg.core.master.protocol.MasterOuterClass.MasterRegisterResult> METHOD_REGISTER =
            io.grpc.MethodDescriptor.create(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
                    generateFullMethodName("Master", "register"),
